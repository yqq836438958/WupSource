...
public class QRomQuaFactory {
	private static final String TAG = "QRomQuaFactory";
    ...
    public  static String buildQua(Context context) {
    	...
    	QRomLog.i(TAG, "build QUA started, current mode is " + QRomWupEnvironment.getBuildQuaMode());
...
//        }
    ...
    public static String getLCID(Context context) {
        if (QRomWupEnvironment.getBuildQuaMode() == QRomWupEnvironment.QuaBuildMode.BuildFromRomSrc) {  // 系统源码模式
